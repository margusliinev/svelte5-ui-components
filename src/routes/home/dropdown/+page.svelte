<script lang="ts">
    import { Dropdown, DropdownButton, DropdownMenu, DropdownItem, Icon, Link } from '$components';
</script>
...
<div class="flex flex-wrap items-center gap-10">
    <Dropdown>
        ...
        <DropdownMenu>
            ...
            <DropdownItem><Link href="#" size="sm" class="!flex !justify-start !rounded-none hover:bg-foreground/10">Logout</Link></DropdownItem>
        </DropdownMenu>
    </Dropdown>
    <Dropdown>
